...
public class FavoriteSoqaAdapter extends RecyclerView.Adapter<FavoriteSoqaAdapter.MyHolder> {
    ...
    public FavoriteSoqaAdapter(Context context, List<Alsoaq> alsoaqs) {
